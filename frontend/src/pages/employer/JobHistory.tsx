...
import { MapPin, Calendar, DollarSign, Package, Clock, FileText, Users } from 'lucide-react';
...
export default function JobHistory() {
  ...
  const { data: jobs, isLoading, error } = useQuery({
    ...
    enabled: !!token && (user?.role === 'EMPLOYER' || user?.role === 'ADMIN')
  });
